...
<div class="">
  <div class="col-lg-12 col-xs-12 w3-white">
    ...
    @section('formulario')
    <!-- Registrar -->
    <form class="validar Modal" id="InUp_Marca" name="InUp_Marca" action="{{ route('marcaCrea') }}" enctype="multipart/form-data">
                ...
                <div class="panel panel-border-color panel-border-color-primary ">
                  <div class="tab-container ">
                    <ul class="nav nav-tabs">
                      <li class="active"><a href="ui-tabs-accordions.html#Proveedor_Insert" data-toggle="tab">Alta de Marca</a></li>
                    </ul>
